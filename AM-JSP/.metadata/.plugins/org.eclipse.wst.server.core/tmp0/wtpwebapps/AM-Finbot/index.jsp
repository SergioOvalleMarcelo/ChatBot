...
<body>
  ...
  <nav class="my-2 my-md-0 mr-md-3">
    ...
    <a class="p-2  linkMenus" href="#sobre">SOBRE NOS</a>
    <a class="p-2  linkMenus" href="#sugestões">SUGESTOES</a>
    <a class="p-2  linkMenus" href="#identidade">NOSSA IDENTIDADE</a>
    <a class="p-2  linkMenus" href="#chatBot">CHATBOT</a>
    <a class="p-2  linkMenus" href="#equipe">EQUIPE</a>
    <a class="p-2  linkMenus" href="#contato">CONTATO</a>
  </nav>
  <a class="btn botaoMenu" href="login.jsp">LOGIN</a>
</div>
...
<div class="tipoContainer2 parallax3" id="sobre">
  <div class="qualquer">
    <div id="fundo">
      <div class="container">
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            <p id="subtituloParalax">Conheca um pouco sobre nosso projeto com uma apresentacão sobre o chatBot,metas e Boa Gestão!!!</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="py-5 fundo2">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <div class="card fundo2">
          <div class="card-body">
            <img class="card-img-top primeirasImagens" src="image/ChatBot.png" alt="Card image cap">
            <h3 class="card-title subtituloInicio">ChatBot</h3>
            <p class="card-text textoConteudo">O chatbot se comunica com o usuário, perguntando suas metas e objetivo , a partir do informado pelo usuário o sistema analisa a viabilidade do objetivo informado e oferece uma série de sugestões com o tempo e o custo necessário.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card fundo2">
          <div class="card-body">
            <img class="card-img-top primeirasImagens" src="image/imagemQualquer.png" alt="Card image cap">
            <h3 class="card-title subtituloInicio">Gestão</h3>
            <p class="card-text textoConteudo">Equilibrar gastos com as necessidades e desejos é uma prática saudável. Você compromete o salário antes de receber, não dá preferência para comprar à vista, consome mais do que ganha e não planeja para possiveis complicações?</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card fundo2">
          <div class="card-body">
            <img class="card-img-top primeirasImagens" alt="Card image cap" src="image/meta.png">
            <h3 class="card-title subtituloInicio">Metas</h3>
            <p class="card-text textoConteudo">Nossa meta é ajudar você conquistar seus objetivos, realizar investimentos de forma facil e segura, o uso consciente dos cartões, contribuir uma poupança e a economizae para comprar um carro ou realizar a viagem dos sonhos.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="tipoContainer2 parallax4" id="sugestões">
  <div class="qualquer">
    <div id="fundo">
      <div class="container">
        <div class="row">
...
<div class="container">
  ...
  <div class="fundoVideo">
    ...
    <div class="py-5" id="identidade">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="subtitulo">Nossa Identidade</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="card ">
              <div class="card-body">
                <img class="card-img-top sobremvs" src="image/missao.png" alt="Card image cap">
                <h3 class="card-title subtituloMVC">Missão</h3>
                <p class="card-text textoConteudo">Nossa missão é educar os jovens de maneira fácil e didática a lidar com suas finanças de forma responsável, permitindo que eles aprendam a resolver seus problemas e dêem os primeiros passos no sentido de alcançar seus objetivos.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card">
              <div class="card-body">
                <img class="card-img-top sobremvs" src="image/visao.png" alt="Card image cap">
                <h3 class="card-title subtituloMVC">Visão</h3>
                <p class="card-text textoConteudo">Ser a escolha natural dos jovens em software para auxílio em sua vida finanças, expandir a idade de usuarios podendo auxiliar na vida financeira com grandes investimentos e expandir as nossas fronteiras</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card">
              <div class="card-body">
                <img class="card-img-top sobremvs" alt="Card image cap" src="image/valores.png">
                <h3 class="card-title subtituloMVC">Valores</h3>
                <p class="card-text textoConteudo">Respeito com nossos usuários. Integridade com os dados do usuario. Garantir que nosso suporte e o chatBot consiga resolver seus conflitos. Garantia de uma melhora com relação sua vida financeira.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="tudoEquipe" id="equipe">
      <div class="container">
        <h1 class="subtitulo">Equipe</h1>
        <div class="row">
          <div class="col-md-4 centroEquipe">
            <img class="imgEquipe"src="image/sergio.jpg" alt="">
            <h3 class="NomeMembro">Sergio Ovalle</h3>
            <p class="descricaoMembro">Responsável pelo Front-End</p>
          </div>
          <div class="col-md-4 centroEquipe">
            <img class="imgEquipe"src="image/piero.jpg" alt="">
            <h3 class="NomeMembro">Piero Barbosa</h3>
            <p class="descricaoMembro">Responsável pelo ChatBot</p>
          </div>
          <div class="col-md-4 centroEquipe">
            <img class="imgEquipe" src="image/thiago.jpg" alt="">
            <h3 class="NomeMembro">Thiago Almeida</h3>
            <p class="descricaoMembro">Responsável pelo ChatBot</p>
          </div>
        </div>
        <br><br><br>
        <div class="row">
          <div class="col-md-4 centroEquipe">
            <img class="imgEquipe" src="image/leandro.jpg" alt="">
            <h3 class="NomeMembro">Leandro</h3>
            <p class="descricaoMembro">Responsável pela documentação</p>
          </div>
          <div class="col-md-4 centroEquipe">
            <img class="imgEquipe"src="image/ricardo.jfif" alt="">
            <h3 class="NomeMembro">Ricardo</h3>
            <p class="descricaoMembro">Responsável pelo Banco de Dados</p>
          </div>
          <div class="col-md-4 centroEquipe">
            <img class="imgEquipe"src="image/talles.jfif" alt="">
            <h3 class="NomeMembro">Talles</h3>
            <p class="descricaoMembro">Responsável pelo Back-End</p>
          </div>
        </div>
      </div>
    </div>
